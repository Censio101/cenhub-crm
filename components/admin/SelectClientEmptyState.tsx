...
export function SelectClientEmptyState() {
  ...
  return (
    <div className="admin-ui mx-auto flex max-w-lg flex-col items-center gap-4 rounded-2xl border border-[#d3c3b2] bg-card px-8 py-12 text-center shadow-[0_1px_3px_rgba(26,18,8,0.06)]">
